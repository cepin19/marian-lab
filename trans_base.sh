...
$marian/guessmarian-decoder -v model/encs.spm model/encs.spm  -m $m --beam-size 6 --mini-batch 32 --maxi-batch 100 --maxi-batch-sort src -w 128 --cpu-threads 16  --log trans_base.log # > news19.translated
