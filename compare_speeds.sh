...
for trans in trans_base.sh  trans_own.sh trans_base_beam1.sh  trans_student_base.sh trans_student_base_beam1.sh trans_student_base_shortlist.sh trans_student_tiny.sh 
do
